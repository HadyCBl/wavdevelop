...
switch ($condi) {
    case 'lib':
        ...
        FROM aprmov INNER JOIN tb_usuario usu ON usu.id_usu = aprmov.codusu WHERE aprmov.cestado != 2 AND aprmov.ccodaport = '$ccodaport' AND aprmov.nlibreta = $libreta AND aprmov.lineaprint = 'N'");
