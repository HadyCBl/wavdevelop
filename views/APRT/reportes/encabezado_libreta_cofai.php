...
$dpi="";
$data = mysqli_query($conexion, "SELECT `short_name`,`Direccion`, `no_identifica`, `tel_no1`, `no_tributaria` FROM `tb_cliente` WHERE `idcod_cliente` = '$idcli'");
...
// $pdf->Text($x, $y, decode_utf8($nombre));
