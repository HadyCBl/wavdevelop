...
$pdf->Text($x + 3, $y+1, mb_convert_encoding($nombre, 'ISO-8859-1', 'UTF-8'));
// $fecha_apertura = date("d-m-Y", strtotime($fecha_apertura));
// $pdf->Text($x + $espaciosegundacol, $y, $fecha_apertura);
$pdf->Text($x + 79, $y + 8, $cuenta);
$pdf->Text($x + 7, $y + 8, $dpi);
$pdf->Text($x + 4, $y + 15.5, mb_convert_encoding($direccion, 'ISO-8859-1', 'UTF-8'));
