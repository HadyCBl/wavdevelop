...
while ($dat = mysqli_fetch_array($data, MYSQLI_ASSOC)) {
    ...
    if ($direccion === "" || is_null($dat["Direccion"])) {
...
$fecha_apertura=($fecha_apertura)?setdatefrench($fecha_apertura):'-';
$pdf->Text($x + $espaciosegundacol + 13, $y, $dpi);
$pdf->Text($x, $y + $espacio, $cuenta);
$pdf->Text($x + $espaciosegundacol + 13, $y + $espacio, ($dpi === "" || is_null($dpi)) ? '-' : $fecha_apertura);
