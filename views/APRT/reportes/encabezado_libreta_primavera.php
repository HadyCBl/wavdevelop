...
// --nombrew cuenta 
$pdf->Text($x + 14,$y -19, mb_convert_encoding($nombre, 'ISO-8859-1', 'UTF-8'));
$pdf->Text($x + 16,$y -13 , $cuenta);
$pdf->Text($x + 14,$y -6 , mb_convert_encoding($direccion, 'ISO-8859-1', 'UTF-8'));
