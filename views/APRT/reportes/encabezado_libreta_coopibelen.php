...
while ($dat = mysqli_fetch_array($data, MYSQLI_ASSOC)) {
    ...
    $direccion = encode_utf8($dat["Direccion"]);
    if ($direccion == "") {
...
$pdf->Text($x + 20,$y -9, mb_convert_encoding($nombre, 'ISO-8859-1', 'UTF-8'));
$pdf->Text($x + 20,$y -2 , $dpi);
$pdf->Text($x + 20,$y +5 , $cuenta);
$pdf->Text($x + 80,$y +5, $fecha_apertura);
