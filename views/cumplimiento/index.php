...
try {
    ...
    $permisos = getpermisosuser($database, $idusuario, 'G', 21, $db_name_general);
...
$idModuleCurrent = 21; // ID DEL MODULO CUMPLIMIENTO
...
<body class="<?= ($_SESSION['background'] == '1') ? 'dark' : ''; ?>">
    ...
    <section class="home">
        <div class="container" style="max-width: none !important;">
            <?php require_once __DIR__ . '/../../src/menu/menu_barh.php'; ?>
    ...
    <script src="../../includes/js/script_cumplimiento.js"></script>
</body>
