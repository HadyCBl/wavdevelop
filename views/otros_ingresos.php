...
try {
  ...
  $permisos = getpermisosuser($database, $idusuario, 'G', 18, $db_name_general);
...
$titlemodule = "Otros Movimientos";
$idModuleCurrent = 18; // ID DEL MODULO OTROS INGRESOS
?>
<!DOCTYPE html>
...
<body class="">
  ...
  // echo Asset::script('otros_ingresos', ['defer' => true]);
  echo AssetVite::script('shared', [
    'type' => 'module'
  ]);
  echo AssetVite::script('otrosingresos', [
    'type' => 'module'
  ]);
