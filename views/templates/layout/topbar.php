...
try {
    ...
    $userData = $database->selectColumns("tb_usuario", ['nombre', 'apellido', 'usu', 'email', 'puesto'], "id_usu=? AND estado=1", [$_SESSION['id']]);
    if (empty($userData)) {
        $showmensaje = true;
        throw new Exception("No se encontraron datos de su usuario, verifique su sesion");
    }
    ...
    <div
        ...
        <div
            ...
            <a href="index.html" class="lg:hidden">
                <img class="dark:hidden w-8 h-8" src="<?= BASE_URL; ?>/assets/svg/iconms.svg" alt="Logo" />
                <img
                    class="hidden dark:block w-8 h-8"
                    src="<?= BASE_URL; ?>/assets/svg/iconms.svg"
                    alt="Logo" />
            </a>
                ...
                <div
                    ...
                    <div
                        ...
                        <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
                            <!-- USAR ESTA PLANTILLA PARA ALGO SUCCESS O INFO -->
                            <!-- <li>
                                <a
                            ...
                            <!-- USAR ESTA PLANTILLA PARA ALGO DANGER O WARNING -->
                            <!-- <li>
                                <a
                                    class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                    href="#">
            ...
            <div
                ...
                <a
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="<?= BASE_URL; ?>/assets/img/userdefault.png" alt="User" />
                    </span>

                    <span class="text-theme-sm mr-1 block font-medium"> <?= $userData['usu'] ?? ""  ?> </span>
