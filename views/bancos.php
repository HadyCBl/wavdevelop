...
try {
  ...
  $permisos = getpermisosuser($database, $idusuario, 'G', 10, $db_name_general);
...
$titlemodule = "Bancos";
$idModuleCurrent = 10; // ID DEL MODULO BANCOS
?>
<!DOCTYPE html>
...
<body class="">
  ...
  <?php include_once __DIR__ . "/../src/cris_modales/mdls_nombancos.php"; ?>
  <script src="../includes/js/numeroALetras.js"></script>
  <script src="../includes/js/script.js"></script>
  <script src="../includes/js/scrpt_bancos.js"></script>
  <?php
