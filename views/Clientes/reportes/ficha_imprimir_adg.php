...
$pdf->Cell($ancho_linea + 71, $tamanio_linea, $conyuge ?? " ", 0, 0, 'C', true); //nombre conyuge dato
$pdf->Cell($espacio_blanco2, $tamanio_linea, ' ', 0, 0, 'C'); //espacio
...
// Si no hay ingresos, no se muestra nada
//fin ingresos
// $pdf->Ln(5);
//productos
...
// $pdf->firmas(3, [(strtoupper($nombre)),"Responsable de consignar","Responsable de verificar "], 'Arial');
$pdf->Cell($espacio_blanco2, $tamanio_linea, ' ', 0, 0, 'C'); //espacio
$pdf->Cell($ancho_linea+10, $tamanio_linea+3, decode_utf8((strtoupper($nombre))), 'T', 0, 'C');
$pdf->Cell($espacio_blanco2, $tamanio_linea, ' ', 0, 0, 'C'); //espacio
$pdf->Cell($ancho_linea+10, $tamanio_linea+3, 'RESPONSABLE DE CONSIGNAR', 'T', 0, 'C');
$pdf->Cell($espacio_blanco2, $tamanio_linea, ' ', 0, 0, 'C'); //espacio
$pdf->Cell($ancho_linea+10, $tamanio_linea+3, 'RESPONSABLE DE VERIFICAR', 'T', 1, 'C');
$pdf->Cell($espacio_blanco2+63, $tamanio_linea, ' ', 0, 0, 'C'); //espacio
$pdf->Cell($ancho_linea+10, $tamanio_linea-3, 'LA INFORMACION', 0, 0, 'C');
$pdf->Cell($espacio_blanco2, $tamanio_linea, ' ', 0, 0, 'C'); //espacio
$pdf->Cell($ancho_linea+10, $tamanio_linea-3, 'Y AUTORIZAR LA INFORMACION', 0, 0, 'C');
//fin productos
//$pdf->Output();
