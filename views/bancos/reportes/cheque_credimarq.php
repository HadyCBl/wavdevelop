...
function cheque_bancoindustrial($pdf, $registro)
{
    ...
    $pdf->CellFit($ancho_linea + 80, $tamanio_linea + 1, "COMITANCILLO , " . date("d", $fechaSegundos) . " DE " . $meses[date("n", $fechaSegundos) - 1] . " DE " . date("Y", $fechaSegundos), 0, 0, 'L', 0, '', 1, 0);
    ...
    //DETALLE DE CHEQUE
    //cuenta de banco
    $pdf->CellFit($ancho_linea + 10, $tamanio_linea + 1, " ", 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->Ln(87); //--REQ--fape--2--Ninguno
    
    $pdf->CellFit($ancho_linea + 150, $tamanio_linea + 1, $hoy, 0, 0, 'R', 0, '', 1, 0);
