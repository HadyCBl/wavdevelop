...
function cheque_bancoindustrial($pdf, $registro)
{
    ...
    $pdf->CellFit($ancho_linea + 80, $tamanio_linea + 1, "PLAYA GRANDE, IXCAN, " . date("d", $fechaSegundos) . " DE " . $meses[date("n", $fechaSegundos) - 1] . " DE " . date("Y", $fechaSegundos), 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 13);
