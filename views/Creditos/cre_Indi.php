...
try {
  ...
  $permisos = getpermisosuser($database, $idusuario, 'R', 5, $db_name_general);
...
<head>
  ...
  <title>Crédito Individual</title>
  <link rel="shortcut icon" type="image/x-icon" href="../../includes/img/favmicro.ico">
  <link rel="stylesheet" href="../../includes/css/style.css">
  <!-- <link rel="stylesheet" href="../../includes/css/StlsVarios.css"> -->

  <?php require_once __DIR__ . '/../../includes/incl.php'; ?>
</head>

<body class="">
  <?php require __DIR__ . '/../../src/menu/cre_menu.php';
  ?>
    ...
    <div class="container" style="max-width: none !important;">
      <div class="row">
        <div class="col d-flex justify-content-start">
          <div class="text">Crédito Individual</div>
        </div>
      ...
      <!-- NAV DE BOTONES PARA mostrar panel -->
  ...
  <!-- #region -->
  <script src="../../includes/js/numeroALetras.js"></script>
  <!-- cuando se agrega este script nunca se detiene el loader -->
  <script src="../../includes/js/script.js"></script>
  <script src="../../includes/js/scrpt_cre_indi.js"></script>
  <script src="../../includes/js/globalFunctions.js"></script>
  <!-- <script src="../../includes/js/all.min.js"></script> -->

  <script>
    function salir() {
      $(location).attr('href', 'creditos.php');
    }
  </script>
</body>
