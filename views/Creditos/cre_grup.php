...
try {
  ...
  $permisos = getpermisosuser($database, $idusuario, 'R', 6, $db_name_general);
...
<body class="">
    ...
    <div class="container" style="max-width: none !important;">
      <div class="row">
        <div class="col d-flex justify-content-start">
          <div class="text">CRÉDITO GRUPAL</div>
        </div>
  ...
  <?php
  include_once __DIR__ . "/../../src/cris_modales/mdls_credlin.php";
  include_once __DIR__ . "/../../src/cris_modales/mdls_grupos.php"; ?>
  <script src="../../includes/js/script.js"></script>
  <script src="../../includes/js/credito_grupo.js"></script>
