...
try {
  ...
  $permisos = getpermisosuser($database, $idusuario, 'R', 7, $db_name_general);
...
<body class="">
  ...
  <?php include_once __DIR__ . "/../../src/cris_modales/mdls_grupos.php"; ?>
  <script src="../../includes/js/script.js"></script>
  <script src="../../includes/js/scrpt_caja.js"></script>
  <?php
  // Asset::script('shared', ['defer' => true]);
  // Asset::script('caja', ['defer' => true]);
  echo AssetVite::script('shared', [
    'type' => 'module'
  ]);
  echo AssetVite::script('caja', [
    'type' => 'module'
  ]);
  if (!$isProduction) {
