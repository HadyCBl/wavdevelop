...
try {
    ...
    $query = "SELECT gru.*,cli.url_img, cli.short_name,cli.idcod_cliente,cli.date_birth,cli.no_identifica, cli.genero,
            ...
            WHERE cre.TipoEnti='GRUP' AND cre.CESTADO='D' AND cre.CCodGrupo=?  AND cre.NCiclo=? ORDER BY cre.CCODCTA";
...
function printpdf($registro, $info)
{
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell($ancho_linea * 2, 7,  $this->datos[0]["NCiclo"], '', 0, 'L');
            ...
            $this->Cell($ancho_linea * 2, 7, $this->datos[0]["noPeriodo"], '', 0, 'L');
            ...
            $this->Cell($ancho_linea * 2, 7, $this->datos[0]["descripcion"], '', 0, 'L');

            $this->Cell($ancho_linea, 7, 'PRODUCTO:', '', 0, 'L');
            $this->Cell(0, 7, Utf8::decode($this->datos[0]["nomproducto"]), '', 1, 'L');
