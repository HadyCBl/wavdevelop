...
printpdf($conexion, $codusu, $usuCli, $codCu, $nombreGrupo, $db_name_general);

function printpdf($conexion, $codusu, $usuCli, $codCu, $nombreGrupo, $db_name_general)
{
   ...
   WHERE credi.Cestado = 'F'  AND credi.ccodcta =" . $codCu);
    ...
    $pdf->Cell(60, 0, "Nombre del grupo: " . $nombreGrupo, 0, 0, 'L');
    $pdf->Ln(6);
