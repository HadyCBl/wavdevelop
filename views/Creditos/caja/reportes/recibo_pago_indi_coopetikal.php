...
function reciboCiacreho($pdf, $registro, $hoy, $usuario, $info)
{
    ...
    $pdf->CellFit($tabular + 52, $tamanio_linea + 2, (Utf8::decode(mb_strtoupper($registro[0][2], 'utf-8'))), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(4);
    //DPI 
    $pdf->CellFit($ancho_linea2 + 30, $tamanio_linea + 2, " ", 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->CellFit($ancho_linea2 * 2, $tamanio_linea + 2, 'USUARIO: ' . Utf8::decode(Utf8::decode(mb_strtoupper($usuario, 'utf-8'))), 0, 0, 'L', 0, '', 1, 0);
}
