...
function recibo($pdf, $registro, $hoy, $usuario, $info)
{
    ...
    $total_saldo = $registro[0][7] + $registro[0][8];
    ...
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, 'FECHA DOCTO.', 0, 0, 'L', 0, '', 1, 0);
    $pdf->SetFont($fuente, 'B', 9);
    ...
    // $pdf->CellFit($ancho_linea2 + 5, $tamanio_linea + 1, mb_strtoupper($registro[0][6], 'utf-8'), 0, 0, 'R', 0, '', 1, 0);
    ...
    $pdf->CellFit($ancho_linea2 - 32, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->CellFit($ancho_linea2 - 1, $tamanio_linea + 2, 'SALDO ANTERIOR', 'L-R-T', 0, 'C', 0, '', 1, 0);
    $pdf->Ln(5);

    //NOMBRE Y MORA
    $pdf->CellFit($ancho_linea2 * 2, $tamanio_linea + 1, mb_convert_encoding(mb_strtoupper($registro[0][2], 'utf-8'), 'ISO-8859-1', 'UTF-8'), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 32, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->CellFit($ancho_linea2 - 6, $tamanio_linea + 2, $saldo_anterior, 'R-B', 0, 'R', 0, '', 1, 0);
    ...
    //PRESTAMO Y OTROS
    $pdf->CellFit($ancho_linea2 - 10, $tamanio_linea + 1, 'CUENTA:', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 + 8, $tamanio_linea + 1, $registro[0][3], 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 30, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->CellFit(1, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 1, $tamanio_linea + 2, 'SALDO ACTUAL', 'L-R-T', 0, 'C', 0, '', 1, 0);
    $pdf->Ln(5);

    //CANTIDAD EN LETRAS
    $pdf->CellFit($ancho_linea2 * 2 - 2, $tamanio_linea + 1, 'Cantidad en letras:', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 30, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 2, 'TOTAL', 'L-R-B', 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(5, $tamanio_linea + 2, 'Q', 'L-B', 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 5, $tamanio_linea + 2, $registro[0][11], 'R-B', 0, 'R', 0, '', 1, 0);
    $pdf->CellFit(1, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(5, $tamanio_linea + 2, 'Q', 'L-B', 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 6, $tamanio_linea + 2, $saldocapital, 'R-B', 0, 'R', 0, '', 1, 0);
    $pdf->Ln(6);
    ...
    //USUARIO
    $pdf->CellFit(0, $tamanio_linea + 1, 'USUARIO:' . mb_convert_encoding(mb_strtoupper($usuario, 'utf-8'), 'ISO-8859-1', 'UTF-8'), 0, 0, 'C', 0, '', 1, 0);
    $pdf->Ln(30);
}
