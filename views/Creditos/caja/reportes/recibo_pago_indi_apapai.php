...
{
    $margen_izq = 0; // Cambia este valor para mover el contenido a la izquierda o derecha

    // Establecer márgenes personalizados usando la variable
    $pdf->SetMargins($margen_izq, 20, 20); // margen izquierdo, superior, derecho
    $fuente = "Courier";
    $tamanio_linea = 3;
    $ancho_linea2 = 30;
    ...
    $pdf->CellFit($ancho_linea2 + 140, $tamanio_linea + 1, ' ', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, date("d-m-Y", strtotime($registro[0][1])), 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(10);

    $pdf->CellFit($ancho_linea2 + 140, $tamanio_linea + 1, ' ', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, $registro[0][4], 0, 1, 'L', 0, '', 1, 0);
    $pdf->Ln(3);
    // $pdf->CellFit($ancho_linea2 - 20, $tamanio_linea + 1, ' ', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 + 130, $tamanio_linea + 1, Utf8::decode(mb_strtoupper($registro[0][2], 'utf-8')), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, $registro[0][13], 0, 1, 'L', 0, '', 1, 0);
    $pdf->Ln(4);

    // $pdf->CellFit($ancho_linea2 - 20, $tamanio_linea + 1, ' ', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 + 130, $tamanio_linea + 1, Utf8::decode(mb_strtoupper($registro[0][14], 'utf-8')), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 + 10, $tamanio_linea + 1, $registro[0][3], 0, 0, 'L', 0, '', 1, 0);

    $pdf->Ln(11);

    $pdf->SetFont($fuente, 'B', 9);
    //FECHA DOCTO Y FUENTES
    $pdf->CellFit($ancho_linea2 + 33, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->CellFit($ancho_linea2 + 25, $tamanio_linea + 1, date("d-m-Y", strtotime($registro[0][1])), 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 2, number_format($registro[0][7], 2, '.', ','), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(5);

    //FECHA APLICA Y CAPITAL
    $pdf->CellFit($ancho_linea2 + 62, $tamanio_linea + 1, 'No. Documento: ' . $registro[0][4], 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 5, $tamanio_linea + 2, 'INTERES', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(5, $tamanio_linea + 2, 'Q', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 2, number_format($registro[0][8], 2, '.', ','), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(5);

    //NOMBRE Y MORA
    $pdf->CellFit($ancho_linea2 + 62, $tamanio_linea + 1, 'CUENTA: ' . $registro[0][3], 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->CellFit($ancho_linea2,$tamanio_linea + 2,($registro[0][9] == 0 ? ' ' : number_format($registro[0][9], 2, '.', ',')),0,0,'L',0,'',1,0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->Ln(5);

    //PRESTAMO Y OTROS
    $pdf->CellFit($ancho_linea2 + 5, $tamanio_linea + 3, 'SALDO: ' . number_format($registro[0][12],2,'.',','), 1, 0, 'L', 0, '', 1, 0);
    ...
    //TOTAL
    $pdf->CellFit($ancho_linea2 + 5, $tamanio_linea + 3, ' ', '0', 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 + 27, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 5, $tamanio_linea + 2, 'TOTAL', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(5, $tamanio_linea + 2, 'Q', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 2, $registro[0][11], 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(1, $tamanio_linea + 1, ' ', 0, 1, 'L', 0, '', 1, 0);
    $pdf->Ln(3);

    $pdf->MultiCell(145, $tamanio_linea + 1, 'CONCEPTO: '.Utf8::decode(mb_strtoupper($registro[0][5], 'utf-8')), 0, 'L');
    $pdf->Ln(8);
    ...
    $pdf->MultiCell(170, $tamanio_linea + 1, Utf8::decode($format_monto->toMoney($decimal[0], 2, '', '')) . $res . "/100", 0, 'L');
