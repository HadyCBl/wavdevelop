...
function printpdf($usuario,$usuarioag, $codigocredito, $numerocuota, $cnuming, $registro, $info)
{
    ...
    if ($usuarioag == 1) {
        ...
        recibo2($pdf, $registro, $hoy, $usuario, $info);
    } else {
...
function recibo2($pdf, $registro, $hoy, $usuario, $info)
{
    ...
    $pdf->CellFit(0, $tamanio_linea, 'MONTO EN LETRAS: ' . decode_utf8($format_monto->toMoney($decimal[0])) . $res . "/100", 0, 1, 'L', 0, '', 1, 0);
