...
function recibo($pdf, $registro, $hoy, $usuario, $info)
{
    ...
    $fecha = date("d-m-Y", strtotime($registro[0][0]));
    $fecha_partes = explode("-", $fecha);
    $dia = $fecha_partes[0];
    $mes = $fecha_partes[1];
    $anio = $fecha_partes[2];
    
    $pdf->CellFit($ancho_linea2+35, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(10, $tamanio_linea + 1, $dia, 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(23, $tamanio_linea + 1, $mes, 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(15, $tamanio_linea + 1, $anio, 0, 0, 'C', 0, '', 1, 0);
    
    //NOMBRE CLIENTE
    $pdf->Ln(10);
    $pdf->CellFit(0, $tamanio_linea + 1,Utf8::decode(mb_strtoupper($registro[0][2], 'utf-8')), 0, 0, 'C', 0, '', 1, 0);
    
    //CONCEPTOS
    $pdf->Ln(15);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1,'CAPITAL', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2+67, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(5, $tamanio_linea + 1, 'Q', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(25, $tamanio_linea + 1, $registro[0][7], 0, 0, 'R', 0, '', 1, 0);
    $pdf->Ln(6);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1,'INTERESES', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2+67, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(5, $tamanio_linea + 1, 'Q', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(25, $tamanio_linea + 1, $registro[0][8], 0, 0, 'R', 0, '', 1, 0);
    $pdf->Ln(6);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1,'MORA', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2+67, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(5, $tamanio_linea + 1, 'Q', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(25, $tamanio_linea + 1, $registro[0][9], 0, 0, 'R', 0, '', 1, 0);
    $pdf->Ln(6);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1,'OTROS', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2+67, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(5, $tamanio_linea + 1, 'Q', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(25, $tamanio_linea + 2, $registro[0][10], 0, 0, 'R', 0, '', 1, 0);
    $pdf->Ln(10);
    $pdf->CellFit($ancho_linea2, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2+97, $tamanio_linea + 1,'TOTAL', 0, 0, 'R', 0, '', 1, 0);
    $pdf->CellFit(5, $tamanio_linea + 1, 'Q', 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(25, $tamanio_linea + 1, $registro[0][11], 0, 0, 'R', 0, '', 1, 0);
    ...
    // $pdf->CellFit($ancho_linea2 + 23, $tamanio_linea + 1, date("d-m-Y", strtotime($registro[0][0])), 0, 0, 'L', 0, '', 1, 0);
