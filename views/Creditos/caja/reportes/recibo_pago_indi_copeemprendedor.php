...
function recibo($pdf, $registro, $hoy, $usuario, $info)
{
    ...
    $pdf->CellFit($ancho_linea2 - 5, $tamanio_linea + 1,  'FECHA DOCT.', 'L-R-T', 0, 'L', 0, '', 1, 0);
    ...
    //NOMBRE Y MORA
    $pdf->CellFit($ancho_linea2 + 53, $tamanio_linea + 1, decode_utf8(mb_strtoupper($registro[0][2], 'utf-8')), 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit($ancho_linea2 - 23, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
    ...
    $pdf->MultiCell(0, $tamanio_linea + 2, decode_utf8($format_monto->toMoney($decimal[0], 2, '', '')) . $res . "/100", 0, 'L');
    // $pdf->Ln(5);
    $pdf->MultiCell(0, $tamanio_linea + 2, 'Codigo Cliente: ' . $registro[0][15], 0, 'L');
    $pdf->MultiCell(0, $tamanio_linea + 2, decode_utf8(mb_strtoupper($registro[0][5], 'utf-8')), 0, 'L');
    $pdf->Ln(-4);


    $nomcompletousuario = decode_utf8(mb_strtoupper($registro[0][13] . ' ' . $registro[0][14], 'utf-8'));
    //USUARIO
    $pdf->firmas(2, [decode_utf8(mb_strtoupper($registro[0][2], 'utf-8')), $nomcompletousuario], 'Courier');
}
...
//     $pdf->SetFont($fuente, 'B', 11);
//     //NOMBRE Y MORA
//     $pdf->CellFit($ancho_linea2 + 53, $tamanio_linea + 1, decode_utf8(mb_strtoupper($registro[0][2], 'utf-8')), 'L-B-R', 0, 'L', 0, '', 1, 0);
//     $pdf->CellFit($ancho_linea2 - 23, $tamanio_linea + 1, ' ', 0, 0, 'L', 0, '', 1, 0);
//     $pdf->CellFit($ancho_linea2 + 5, $tamanio_linea + 2, 'MORA', 'L-R', 0, 'L', 0, '', 1, 0);
//     $pdf->CellFit(5, $tamanio_linea + 2, 'Q', 'L', 0, 'C', 0, '', 1, 0);
//     $pdf->CellFit($ancho_linea2, $tamanio_linea + 2, $registro[0][9], 'R', 0, 'R', 0, '', 1, 0);
...
//     $pdf->Ln(4);
//     $pdf->MultiCell(0, $tamanio_linea + 1, decode_utf8($format_monto->toMoney($decimal[0], 2, '', '')) . $res . "/100", 'L-B-R', 'L');
//     $pdf->SetFont($fuente, 'B', 12);
//     $pdf->Ln(4);
//     $pdf->MultiCell(0, $tamanio_linea + 1, decode_utf8(mb_strtoupper($registro[0][5], 'utf-8')), 0, 'L');
//     $pdf->Ln(5);
//     //USUARIO
//     $pdf->CellFit(0, $tamanio_linea + 1,decode_utf8(mb_strtoupper( 'USUARIO:' . $usuario,'utf-8' )), 0, 0, 'C', 0, '', 1, 0);
// }