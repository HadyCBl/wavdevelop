...
function recibo($pdf, $registro, $hoy, $usuario, $info)
{
    ...
    $nitins = $info[0]["nit"];
    $rutalogomicro = "../../../../includes/img/credinorte.png";
    ...
    $pdf->Image($rutalogomicro, 10, 25, 30, 0, 'PNG');
    // $pdf->SetX(40); // Ajusta el valor 40 según la posición deseada en el eje X
    $pdf->CellFit(0, $tamanio_linea + 1, 'Cormecial Norte', 0, 1, 'C', 0, '', 1, 0);
    $pdf->CellFit(0, $tamanio_linea + 1, 'Barrio el Centro Chisec A.V', 0, 1, 'C', 0, '', 1, 0);
    $pdf->CellFit(0, $tamanio_linea + 1, 'Tels: 57510802 - 30587756', 0, 1, 'C', 0, '', 1, 0);
