...
$queryins = mysqli_query($conexion, "SELECT ins.*, ag.* FROM $db_name_general.info_coperativa ins
...
/*  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    +++++++++++++++++++++++++++++++++++++++ DATOS DEL CREDITO ++++++++++++++++++++++++++++++++++++++++++++++++
    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
$queryInf = mysqli_query($conexion, "SELECT credi.CCODCTA AS ccodcta, cli.short_name AS nombre, credi.NCapDes AS montodes, credi.DFecDsbls fecdes, credi.CODAgencia, ag.nom_agencia
    FROM tb_cliente AS cli 
    INNER JOIN cremcre_meta AS credi ON cli.idcod_cliente = credi.CodCli
    LEFT JOIN tb_agencia ag ON ag.cod_agenc = credi.CODAgencia
...
function printpdf($info, $infoPP, $infocredito)
{
    class PDF extends FPDF
    {
        ...
        public function __construct($info, $infocredito, $nomAgencia)
        {
            parent::__construct();
            $this->info = $info;
        ...
        function Header()
        {
            ...
            $this->Cell(0, 3, mb_strtoupper($this->nomAgencia, 'utf-8'), 'B', 1, 'C');
            ...
            $this->Cell(0, 5, 'Cliente : ' . utf8_decode(mb_strtoupper($this->infocredito[0]['nombre'], 'utf-8')), 0, 1, 'L');
    ...
    $pdf = new PDF($info, $infocredito, $infocredito[0]['nom_agencia']);
