...
function printpdf($datos, $garantias, $clientefiador, $info, $conexion)
{
    ...
    $pdf->SetFont('Times', '', 9);
    $pdf->CellFit(8, 5, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(77, 5, '(Deudor) ' .strtoupper(decode_utf8($datos[0]['nomcli'])), 0, 0, 'C', 0, '', 1, 0);
    $pdf->CellFit(20, 5, ' ', 0, 0, 'L', 0, '', 1, 0);
    $pdf->CellFit(77, 5, '(Fiador) ' . strtoupper(decode_utf8($clientefiador[0]['nomcli'])), 0, 0, 'C', 0, '', 1, 0);
    $pdf->Ln(5);
