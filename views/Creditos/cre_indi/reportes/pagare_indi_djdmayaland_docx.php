...
$cell2->addText(
    "DJD INVERSIONES MAYALAND, SOCIEDAD ANÓNIMA",
...
$cell2->addText(
    "Teléfonos: 3147-8609 y 3144-2273",
    ['bold' => false, 'name' => 'Arial', 'size' => 9],
    ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER, 'spaceAfter' => 0]
);

$cell2->addText(
    "inversionesmayaland@gmail.com",
    ['bold' => false, 'name' => 'Arial', 'size' => 9],
    ['alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER, 'spaceAfter' => 0]
);
...
$textRun = $section->addTextRun($paragraphJustify);
$textRun->addText('Por medio del Presente Título de Crédito consistente en Pagaré, prometemos pagar incondicionalmente a la orden de la entidad denominada: DJD INVERSIONES MAYALAND, SOCIEDAD ANONIMA; con domicilio en aldea Mayaland, del municipio de Ixcán, del departamento de El Quiché. ', ['bold' => false, 'name' => 'Arial', 'size' => 7]);
...
con un porcentaje del '.$monto_gasto_producto.'% sobre el total aprobado, el cual será amortizado mediante doce pagos de forma mensual. El gasto administrativo programado va 
calculado e incluido en las cuotas antes indicadas.', ['bold' => false, 'name' => 'Arial', 'size' => 7]); 

$textRun = $section->addTextRun($paragraphJustify);
$textRun->addText('INVERSION VINCULADO: ', ['bold' => true, 'name' => 'Arial', 'size' => 7]); 
$textRun->addText('Adicional a los intereses y gastos administrativos se aplicará una cuota de inversion vinculado, con un porsentaje de 2% sobre el total aprobado, el cual será amortizado 
de forma mensual, el saldo acumulado será devuelto al cliente al cancelar el crédito. La inversion programada va calculado en las cuotas antes indicadas', ['bold' => false, 'name' => 'Arial', 'size' => 7]); 

$textRun = $section->addTextRun($paragraphJustify);
$textRun->addText('  ', ['bold' => false, 'name' => 'Arial', 'size' => 7]);
...
Protesto) de esta misma fecha a favor de la, DJD INVERSIONES MAYALAND, SOCIEDAD ANONIMA, el cual está contenido en una hoja de papel bond tamaño oficio, hábil en su anverso y reverso, la cual número sello y firmo en constancia de 
