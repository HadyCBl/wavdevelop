...
function printpdf($conexion, $codusu, $usuCli, $codCu, $db_name_general)
{
    ...
    $saldoAnterior = $infoPP[0]['NCapDes'];
    for ($con = 0; $con < $totalFilas; $con++) {
        ...
        $saldoActual = $saldoAnterior - $infoPP[$con]["ncapita"];
        $saldoActual_formatted = number_format($saldoActual, 2);
        $pdf->CellFit(28, 7, 'Q ' . $saldoActual_formatted, 'RL', 1, 'R', 0, '', 1, 0);
        $saldoAnterior = $saldoActual;
    }
    $pdf->CellFit(180, 3, ' ', 'T', 1, 'R', 0, '', 1, 0);
    $pdf->CellFit(40, 7, 'TOTAL', 0, 0, 'R', 0, '', 1, 0);
    ...
    $pdf->CellFit(28, 7, 'Q ' . number_format($sumkp, 2), 0, 0, 'R', 0, '', 1, 0);
    $pdf->CellFit(28, 7, ' ', 0, 0, 'R', 0, '', 1, 0);
    $pdf->CellFit(28, 7, ' ', 0, 0, 'R', 0, '', 1, 0);
