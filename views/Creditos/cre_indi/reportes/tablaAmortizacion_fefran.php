...
switch ($tipo) {
    case 'xlsx';
        ...
        break;
    case 'pdf':
        printpdf($fchspgs, $amortiza, $montoCredito, $gastosDistribuidos, $gastosCuota);
        break;
}

function printpdf($fchspgs, $amortiza, $montoCredito, $planPago, $gastosCuota = [])
{
    class PDF extends FPDF
    {
        private $montoCredito;

        function __construct($montoCredito)
        {
