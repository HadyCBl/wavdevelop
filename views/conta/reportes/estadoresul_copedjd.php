...
function printpdf($registro, $datos, $info, $cuentasingreso, $cuentasegreso, $nivelinit, $nivelfin)
{
    ...
    $pdf->MultiCell(0, 4, strtoupper(decode_utf8('EL INFRASCRITO PERITO CONTADOR: LUCAS JUAN PEDRO, CON NUMERO DE REGISTRO: 103850872, EXTENDIDA POR LA SUPERINTENDENCIA DE ADMINISTRACIÓN TRIBUTARIA SAT, CERTIFICA QUE: LOS DATOS QUE CONTIENE EL PRESENTE ESTADO DE RESULTADOS, SON REALES DE ACUERDO A LOS PRINCIPIOS DE CONTABILIDAD GENERALMENTE ACEPTADOS, REFLEJANDO CLARAMENTE LA SITUACION FINANCIERA DE LA ENTIDAD: COOPERATIVA INTEGRAL DE AHORRO Y CRÉDITO DJD MAYALAND, RESPONSABILIDAD LIMITADA. COMPRENDIDO' . $datos[0])));
