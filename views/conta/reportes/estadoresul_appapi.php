...
function printpdf($registro, $datos, $info, $cuentasingreso, $cuentasegreso, $nivelinit, $nivelfin)
{
    ...
    $pdf->MultiCell(0, 4, strtoupper(decode_utf8('El infrascrito perito contador Diego Brito Raymundo, con NIT 12666149 y con número de registro 111945 ante la Superintendencia de Administración Tributaria certifica: que el estado de resultados que antecede muestra resultado de las operaciones de la asociacion por el periodo comprendido ' . $datos[0] . ', el cual fue obtenido de los registros contables de la entidad.')));
    $pdf->firmas(2, ['DIEGO BRITO RAYMUNDO (CONTADOR)', 'MIGUEL COBO PEREZ (REPRESENTANTE LEGAL)']);
