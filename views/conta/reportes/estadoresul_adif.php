...
function printpdf($registro, $datos, $info, $cuentasingreso, $cuentasegreso, $nivelinit, $nivelfin)
{
    ...
    $pdf->MultiCell(0, 4, strtoupper(decode_utf8('El infrascrito perito contador, con número de registro 1230706-8 ante la Superintendencia de Administración Tributaria certifica: que el estado de resultados que antecede muestra resultado de las operaciones de la asociación por el periodo comprendido ' . $datos[0] . ', el cual fue obtenido de los registros contables de la entidad.')));
