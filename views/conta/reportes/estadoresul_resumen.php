...
/*  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    +++++++++++++++++++++++++++++++++++++++++ VALIDACIONES +++++++++++++++++++++++++++++++++++++++++++++++++++
    +++[`finicio`,`ffin`],[`codofi`,`fondoid`,`nivelinit`,`nivelfin`],[`rfondos`,`ragencia`],[ ] +++
    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
...
try {
    ...
    WHERE estado=1 AND substr(ccodcta,1,1) IN (SELECT clase FROM ctb_parametros_cuentas WHERE id_tipo>=4 AND id_tipo<=5) AND LENGTH(ccodcta) <=13 
    ORDER BY ccodcta;";
...
function printxls($registro, $datos, $cuentasingreso, $cuentasegreso)
{
    ...
    $activa->setCellValue('C1', '7');
    $activa->setCellValue('D1', '6');
    $activa->setCellValue('E1', '5');
    $activa->setCellValue('F1', '4');
    $activa->setCellValue('G1', '3');
    $activa->setCellValue('H1', '2');
    $activa->setCellValue('I1', '1');
    //-------
    $nivelant = 0;
    $totali = 0;
    $totalg = 0;
