...
function printpdf($registro, $datos, $info, $cuentasingreso, $cuentasegreso, $nivelinit, $nivelfin)
{
    ...
    $pdf->MultiCell(0, 4, strtoupper(decode_utf8('EL INFRASCRITO PERITO CONTADOR EDUARDO ABIGAIL ANTONIO CORADO HERNANDEZ, CON REGISTRO 80778003 EXTENDIDA POR LA SUPERINTENDENCIA DE ADMINISTRACIÓN TRIBUTARIA SAT, CERTIFICA QUE: LOS DATOS QUE CONTIENE EL PRESENTE ESTADO DE SITUACION GENERAL, SON REALES DE ACUERDO A PRINCIPIOS DE CONTABILIDAD GENERALMENTE ACEPTADAS, REFLEJANDO CLARAMENTE LA SITUACION FINANCIERA DE LA COOPERATIVA INTEGRAL DE AHORRO Y CREDITO LA REINITA DE IXCAN, RESPONSABILIDAD LIMITADA, DETERMINADO ' . $datos[0] . '.')));
