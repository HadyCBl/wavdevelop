...
function printpdf($registro, $datos, $info, $nivelinit, $nivelfin,  $cuentasactivo, $cuentaspasivo, $cuentascapital, $reguladorasactivo, $cuentacontableer, $resultadoer)
{
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(0, 3, 'BALANCE GENERAL ' . $this->datos[0], 'T', 1, 'C', true);
            $this->Cell(0, 3, '(CIFRAS EN QUETZALES)', 'B', 1, 'C', true);
            //Color de encabezado de lista
            $this->SetFillColor(555, 255, 204);
            //TITULOS DE ENCABEZADO DE TABLA
            /*  $ancho_linea = 21; */
            $ancho_linea = 190 / ($this->nivelfin - $this->nivelinit + 4);
    ...
    // $pdf->Ln(3);
    $pdf->MultiCell(0, 3, strtoupper(decode_utf8('EL INFRASCRITO PERITO CONTADOR: LUCAS JUAN PEDRO, CON NUMERO DE REGISTRO: 103850872, EXTENDIDA POR LA SUPERINTENDENCIA DE ADMINISTRACIÓN TRIBUTARIA SAT, CERTIFICA QUE: LOS DATOS QUE CONTIENE EL PRESENTE BALANCE GENERAL, SON REALES DE ACUERDO A LOS PRINCIPIOS DE CONTABILIDAD GENERALMENTE ACEPTADOS, REFLEJANDO CLARAMENTE LA SITUACION FINANCIERA DE LA ENTIDAD: COOPERATIVA INTEGRAL DE AHORRO Y CRÉDITO DJD MAYALAND, RESPONSABILIDAD LIMITADA. DETERMINADO ' . $datos[0])));
    // $pdf->Ln(10);
