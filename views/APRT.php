...
try {
    ...
    $permisos = getpermisosuser($database, $idusuario, 'G', 3, $db_name_general);
...
$titlemodule = "Aportaciones";
$idModuleCurrent = 3; // ID DEL MODULO APORTACIONES
//-------------
// session_start();
...
<body class="">
    ...
    <?php include_once __DIR__ . "/../src/cris_modales/fun_modal.php"; ?>
    <?php include_once __DIR__ . "/../src/cris_modales/mdls_aport.php"; ?>
    <?php include_once __DIR__ . "/../src/cris_modales/mdls_cli.php"; ?>
    <?php include_once __DIR__ . "/../src/cris_modales/mdls_nomenclatura.php"; ?>


    <script src="../includes/js/script.js"></script>
    <script src="../includes/js/scrpt_aprt.js"></script>
    <script src="../includes/js/scrpt_aprt_aux.js"></script>
    <?php
    // echo Asset::script('shared', ['defer' => true]);
