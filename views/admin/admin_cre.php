...
try {
    ...
    $permisos = getpermisosuser($database, $idusuario, 'A', 15, $db_name_general);
...
<head>
    ...
    ?>
    <script>
        function printdiv1(condi, idiv, dir, xtra) {
            dire = "adminpnls/" + dir + ".php";
            $.ajax({
                url: dire,
                method: "POST",
                data: {
...
<body class="">
        ...
        <div class="container" style="max-width: none !important;">
            <div class="row">
                <div class="col d-flex justify-content-start">
                    <div class="text">Productos Crediticios</div>
                </div>
    ...
    <script src="../../includes/js/srcpt_admincre.js"> </script>
</body>
