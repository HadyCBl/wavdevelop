...
try {
  ...
  $permisos = getpermisosuser($database, $idusuario, 'A', 20, $db_name_general);
...
<body class="">
  ...
  <section class="home">
    <div class="container" style="max-width: none !important;">
      ...
      <div class="btn-group" id="nav_group" role="group">
        ...
        <!-- <div class="btn-group me-1" role="group">
          <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown">Migraciones
            <span class="caret"></span></button>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" style="cursor: pointer;" onclick="printdiv(`clientes`, `#cuadro`, `views001`, `0`)">Clientes</a></li>
            <li><a class="dropdown-item" style="cursor: pointer;" onclick="printdiv(`cremcre_meta`, `#cuadro`, `views001`, `0`)">Creditos</a></li>
            <li><a class="dropdown-item" style="cursor: pointer;" onclick="printdiv(`cremcre_meta_aux`, `#cuadro`, `views001`, `0`)">Generacion de desembolsos</a></li>
            <li><a class="dropdown-item" style="cursor: pointer;" onclick="printdiv(`gen_ppg`, `#cuadro`, `views001`, `0`)">Generacion de planes de pago</a></li>
            <li><a class="dropdown-item" style="cursor: pointer;" onclick="printdiv(`credkar`, `#cuadro`, `views001`, `0`)">credkar</a></li>
          </ul>
        </div> -->
  ...
  <script src="../../includes/js/scriptmigrations.js"></script>
</body>
