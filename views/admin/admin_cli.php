...
try {
  ...
  $permisos = getpermisosuser($database, $idusuario, 'A', 12, $db_name_general);
...
<body class="">
  ...
  <?php   // include_once "../src/mdls_toc.php";
  include_once __DIR__ . "/../../src/cris_modales/modales.php";
  include_once __DIR__ . "/../../src/cris_modales/mdls_cli.php";  ?>
</body>
