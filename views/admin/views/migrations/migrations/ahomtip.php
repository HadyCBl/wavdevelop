...
if (isset($_GET['listen'])) {
    ...
    try {
        ...
        foreach ($datos as $key => $value) {
            ...
            $codigoOficina = $value["ccodofi"] ?? '001';

            // Consultar los códigos existentes para la oficina actual en cada iteración
            // $codigosExistentes = $database->getAllResults(
            //     "SELECT ccodtip FROM ahomtip WHERE ccodofi = ? AND estado = 1",
            //     [$codigoOficina]
            // );
            // $codigosExistentes = array_column($codigosExistentes, 'ccodtip');
            ...
            $ahomtip = array(
                ...
                "inicioCalculo" => $value["inicioCalculo"] ?? 0,
                "estado" => 1,
                "isr" => $value["isr"] ?? 10,
            ...
            $database->insert("ahomtip", $ahomtip);
