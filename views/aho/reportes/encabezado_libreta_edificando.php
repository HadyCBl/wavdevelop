...
$pdf->Text($x, $y + $espacio, mb_convert_encoding($nombre, 'ISO-8859-1', 'UTF-8'));
...
$pdf->Text($x, $y + (2 * $espacio), mb_convert_encoding($direccion, 'ISO-8859-1', 'UTF-8'));
