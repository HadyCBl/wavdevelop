...
$timestamp = strtotime($fecha_apertura);
...
$pdf->Text($x + 6, $y-10, mb_convert_encoding($nombre, 'ISO-8859-1', 'UTF-8'));

$pdf->Text($x + 91, $y - 3, $dia);   // Día
$pdf->Text($x + 101, $y - 3, $mes);   // Mes
$pdf->Text($x + 111, $y - 3, $anio);  // Año

$pdf->SetFont('Calibri', '', 10);
// $pdf->Text($x + 10, $y + 4.5, "  " . ($dpi));

$pdf->Text($x + 6, $y + 1, $codaho);
