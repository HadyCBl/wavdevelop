...
$pdf->EtiquetaValor('ID de la transacción:', $record['Id_RTE']);
...
$pdf->EtiquetaValor('Tipo de moneda:', 'Quetzales');
$pdf->EtiquetaValor('Monto de la transacción:', $MonQ );
$pdf->EtiquetaValor('Monto en dólares:', $MonD);
