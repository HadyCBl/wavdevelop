...
//     return;
// }
// Log::info("tipos documentos: " . json_encode($tiposDocumentosArray));
/*  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    +++++++++++++++++++++++++++++++++++++++ ARMANDO LA QUERY FINAL +++++++++++++++++++++++++++++++++++++++++++
    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
$where = (empty($tiposCuentasArray) || in_array('0', $tiposCuentasArray))
    ? " "
    : " AND SUBSTR(aho.ccodaho,7,2) IN ('" . implode("','", $tiposCuentasArray) . "')";
...
$query2 = "SELECT SUM(CASE WHEN ctipope='D' THEN monto ELSE 0 END) AS depositos,
            ...
            FROM ahommov aho WHERE dfecope<? AND cestado!=2 $where;";
...
$query = "SELECT dfecope,SUM(CASE WHEN ctipope='D' THEN monto ELSE 0 END) AS depositos,
            ...
            FROM ahommov aho WHERE cestado!=2 AND (dfecope BETWEEN ? AND ?) $where 
            GROUP BY dfecope ORDER BY dfecope";
