...
$data = mysqli_query($conexion, "SELECT `short_name`, `no_identifica`,`Direccion` FROM `tb_cliente` WHERE `idcod_cliente` = '$idcli'");
...
$pdf->Text($x, $y+ $espacio, $dpi);
$pdf->Text($x + $espaciosegundacol + $espaciosegundacol, $y + $espacio, $cuenta);
$pdf->Text($x, $y + $espacio + $espacio, $dire);
