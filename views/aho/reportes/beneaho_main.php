...
$accountQuery = mysqli_query($conexion, "SELECT a.*, c.short_name as cnomcli, c.no_identifica as dpi, c.Direccion as direccion, c.tel_no1 as telefono
                                         FROM ahomcta a
...
class PDF extends FPDF
{
    ...
    function AccountInfo()
    {
        ...
        $this->Cell(0, 8, 'Solicitud de Registro de Beneficiarios', 1, 1, 'C');
    ...
    $this->Cell(30, 30, ' ', 1, 1, 'L');
    $this->Cell(60, 8, 'F._________________________', 0, 0, 'L');
    $this->Cell(30, 4, 'Huella', 0, 1, 'C');
    $this->Cell(150, 8, mb_convert_encoding($this->accountDetails['cnomcli'], 'ISO-8859-1', 'UTF-8'), 0, 0, 'L');
    // $this->Ln(5);

    $this->SetFont('Arial', 'B', 9);
    $this->Cell(30, 30, ' ', 1, 1, 'L');
    $this->Cell(90, 8, ' ', 0, 0, 'L');
    $this->Cell(60, 8, 'Vo.Bo._________________________',0, 0, 'L');
    $this->Cell(30, 4, 'Sello', 0, 1, 'C');
    $this->Cell(100, 8, ' ', 0, 0, 'L');
    $this->Cell(50, 8, 'Jefe de Agencia', 0, 1, 'C');
