...
if ($tipcuen == "esp") {
    ...
    $pdf->Text($x, $y + 4, $cuenta);
    $pdf->Text($x, $y + 8 ,karely($plazo) . mb_convert_encoding(" días", 'ISO-8859-1', 'UTF-8'));
    $pdf->Text($x + 50, $y + 8, $tasa_interes . "%");
}else{
    $pdf->Text($x, $y, encode_utf8($nombre));
    $pdf->Text($x, $y + 4, $cuenta);
}
...
// $pdf->Text($x + $espaciosegundacol, $y, $dpi);
// $pdf->Text($x + $espaciosegundacol, $y+40, $tasa_interes . "%");
// $pdf->Text($x + $espaciosegundacol, $y+30, $tipcuen);
