...
if ($agencia != 4) {
    ...
    $pdf->Text($x + 87, $y, "C.I." . ($ci));

    $pdf->Text($x, $y + 6, mb_convert_encoding($direccion, 'ISO-8859-1', 'UTF-8'));
    $pdf->Text($x + 87, $y + 6, ($fecha_apertura));

    $pdf->Text($x, $y + 12, $codaho);
    ...
    $pdf->Text($x + 85, $y - 4, "C.I." . ($ci));

    $pdf->Text($x, $y + 2, mb_convert_encoding($direccion, 'ISO-8859-1', 'UTF-8'));
    $pdf->Text($x + 85, $y + 2, ($fecha_apertura));
    $pdf->Text($x, $y + 8, $codaho);
}
