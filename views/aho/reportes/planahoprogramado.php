...
/*  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
$where = ($radios[0] == "1") ? "" : " AND SUBSTR(aho.ccodaho,7,2)='$tipocuenta'";
...
$query = "SELECT aho.ccodaho, cl.short_name, mov.dfecope, mov.cnumdoc, mov.ctipdoc, mov.ctipope, mov.monto,mov.crazon,tip.nombre tipocuenta
            FROM tb_cliente cl
            ...
            WHERE mov.cestado!=2 AND (mov.dfecope BETWEEN ? AND ?) " . $where . "  ORDER BY mov.dfecope,mov.ccodaho";
...
function printxls($registro)
{
    ...
    $encabezado_tabla = ["FECHA", "CUENTA", "NOMBRE CLIENTE", "DOCUMENTO", "TIPO DOC", "RAZON", "DEPOSITO", "RETIRO","TIPO CUENTA"];
    ...
    $activa->getStyle("A1:I" . $key + 2)->getFont()->setName($fuente);
