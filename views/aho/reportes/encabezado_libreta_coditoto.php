...
$fecha_apertura = date("d-m-Y", strtotime($fecha_apertura));
$pdf->Text($x + $espaciosegundacol - 20, $y, $fecha_apertura);
$pdf->Text($x, $y + 4, mb_convert_encoding($direccion, 'ISO-8859-1', 'UTF-8'));
$pdf->Text($x + 87, $y + 4, (' '));
$pdf->Text($x, $y + 8, $codaho);
$pdf->Text($x + $espaciosegundacol - 20, $y + 4 + $espacio, $dpi);
