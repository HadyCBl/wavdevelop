...
$pdf->Text($x + 6, $y - 0.5, mb_convert_encoding($nombre, 'ISO-8859-1', 'UTF-8'));
$pdf->SetFont('Calibri', '', 9);
$pdf->Text($x + 10, $y + 7, "  " . ($dpi));

$pdf->Text($x + 7, $y + 15, mb_convert_encoding($direccion, 'ISO-8859-1', 'UTF-8'));
$pdf->Text($x + 85, $y + 7, $codaho);
