...
/** source: /var/www/html/app/Controllers/../../views/indicadores/seguros/auxilios.latte */
final class Template_943acb737c extends Latte\Runtime\Template
{
	...
	public function main(array $ʟ_args): void
	{
		...
		echo '<div class="container mx-auto p-4 sm:p-6" x-data="auxiliosApp()">
    <input type="hidden" name="csrf_token"';
		echo LR\HtmlHelpers::formatAttribute(' value', $csrf_token) /* pos 2:52 */;
		echo '>
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-base-content">Gestión de Auxilios Póstumos</h1>
        <p class="text-base-content/70 mt-2">Administra solicitudes, aprobaciones y pagos de auxilios</p>
    </div>

    <!-- Tabs de navegación usando DaisyUI -->
    <div class="card bg-base-100 shadow-xl mb-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="join w-full">
                        <input type="text" x-model="searchTerm" @input.debounce.100ms="buscarCuentas()"
                            placeholder="Ej: Juan Pérez o 001-1234567-8" class="input input-bordered join-item flex-1">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <template x-if="cuenta.renovacion_vigente">
                                                <div class="alert alert-success mt-2">
                                                    <span class="text-sm">✓ Renovación vigente hasta: <span
                                                            class="font-medium"
                                            ...
                                            <template x-if="!cuenta.renovacion_vigente">
                                                <div class="alert alert-warning mt-2">
                                                    <span class="text-sm">⚠️ No hay renovación vigente
                                                        actualmente</span>
                                                </div>
                                            </template>
                                        </div>
                ...
                <dialog x-bind:open="showModalSolicitud" class="modal modal-bottom sm:modal-middle">
                    <div class="modal-box w-11/12 max-w-4xl bg-base-100">
                        ...
                        <form @submit.prevent="crearSolicitud()" id="formSolicitud" action="api/seguros/auxilios"
                            ...
                            <input type="hidden" name="csrf_token"';
		echo LR\HtmlHelpers::formatAttribute(' value', $csrf_token) /* pos 128:76 */;
		echo '>
                            ...
                            <div class="alert alert-info mb-6">
                                <div class="w-full">
                                    ...
                                    <p class="text-sm opacity-70"
                                        x-text="\'Identificación: \' + cuentaSeleccionada?.cliente?.identificacion"></p>
                                    <p class="text-sm opacity-70">
                                        <span>Servicio: </span>
                            ...
                            <div x-show="renovacionValidada" class="mb-6">
                                <div x-show="renovacionValida" class="alert alert-success">
                                    <div>
                                        <p class="font-medium">✓ Renovación vigente en la fecha de fallecimiento</p>
                                        <p class="text-sm mt-1">Monto aprobado automáticamente: <span
                                                class="font-semibold"
                                ...
                                <div x-show="!renovacionValida" class="alert alert-error">
                                    <div>
                                        <p class="font-medium">✗ No hay renovación vigente en la fecha de fallecimiento
                                        </p>
        ...
        <div x-show="activeTab === \'solicitudes\'" class="p-4 sm:p-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                <h2 class="text-xl font-semibold text-base-content">Solicitudes Pendientes de Aprobación</h2>
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            <template x-for="doc in auxilio.documentos" :key="doc.id">
                                                <a :href="\'/api/seguros/auxilios/archivo/\' + doc.ruta" target="_blank"
                                                    ...
                                                    📄 <span x-text="doc.descripcion"></span>
                                                </a>
                                            </template>
                                        </div>
                                    </div>
                    ...
                    <form @submit.prevent="guardarAprobacion()">
                        ...
                        <div class="card bg-gradient-to-r from-warning/10 to-success/10 border border-warning/30 mb-6">
                            <div class="card-body p-5">
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <h3 class="font-semibold text-base-content">Información de la Solicitud</h3>
                                </div>
                        ...
                        <div class="card bg-base-200 mb-6">
                            <div class="card-body p-5">
                                <div class="flex items-center gap-2 mb-4">
                                    ...
                                    <h3 class="font-semibold text-base-content">Datos de Aprobación</h3>
                                </div>
                        ...
                        <div class="modal-action">
                            ...
                            <button type="submit" :disabled="loading" class="btn btn-success">
                                <span x-show="!loading">✓ Aprobar Solicitud</span>
                                <span x-show="loading" class="loading loading-spinner"></span>
                                <span x-show="loading">Procesando...</span>
                            </button>
                        </div>
            ...
            <dialog x-bind:open="showModalPago" class="modal modal-bottom sm:modal-middle">
                <div class="modal-box w-11/12 max-w-2xl bg-base-100">
                    ...
                    <form @submit.prevent="guardarPago()" id="formPago" data-method="POST">
                        <input type="hidden" name="csrf_token"';
		echo LR\HtmlHelpers::formatAttribute(' value', $csrf_token) /* pos 521:72 */;
		echo '>
                        ...
                        <div class="card bg-gradient-to-r from-info/10 to-success/10 border border-info/30 mb-6">
                            <div class="card-body p-5">
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <h3 class="font-semibold text-base-content">Información del Auxilio</h3>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div class="form-control">
                                        ...
                                        <input type="text" x-model="formularioPago.numdoc" name="numdoc"
                                            ...
                                            placeholder="Número de referencia" class="input input-bordered">
                                    </div>
                        ...
                        <div x-show="formularioPago.forma_pago === \'banco\'"
                            ...
                            <div class="card-body p-5">
                                <div class="flex items-center gap-2 mb-4">
                                    ...
                                    <h3 class="font-semibold text-base-content">Información del Cheque</h3>
                                </div>
            ...
            <div class="modal-box modal-large bg-base-100">
                ...
                <div x-show="auxilioDetalle" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div class="card bg-base-200">
                            <div class="card-body p-4">
                                <h3 class="card-title text-base">👤 Asegurado</h3>
                                <div class="space-y-2">
                                    <div>
                        ...
                        <div class="card bg-base-200">
                            <div class="card-body p-4">
                                <h3 class="card-title text-base">📄 Información del Auxilio</h3>
                                <div class="space-y-2">
                                    <div class="grid grid-cols-2 gap-2">
                                        <div>
                    ...
                    <div x-show="auxilioDetalle?.cuenta?.beneficiarios?.length > 0" class="card bg-base-200">
                        <div class="card-body p-4">
                            <h3 class="card-title text-base">👥 Beneficiarios Registrados</h3>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div x-show="auxilioDetalle?.notas" class="alert alert-info py-3">
                            <div class="w-full">
                                <p class="font-semibold mb-1 text-sm">📝 Notas</p>
                        ...
                        <div x-show="auxilioDetalle?.documentos?.length > 0" class="card bg-base-200">
                            <div class="card-body p-3">
                                <h3 class="card-title text-sm">📎 Documentos</h3>
                    ...
                    <div x-show="auxilioDetalle?.estado === \'pagado\' && auxilioDetalle?.pagos?.length > 0"
                        ...
                        <div class="card-body p-4">
                            <h3 class="card-title text-base text-success">💰 Información de Pago</h3>
                    ...
                    <div x-show="auxilioDetalle?.estado === \'rechazado\' && auxilioDetalle?.motivo_rechazo"
                        ...
                        <div class="w-full">
                            <p class="font-semibold mb-1 text-sm">❌ Motivo de Rechazo</p>
                        ...
                        <template x-for="auxilio in historial" :key="auxilio.id">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <template x-if="auxilio.estado === \'pagado\'">
                                        <button @click="reporteManager.generarReporteDirect(
                                        \'seguros/comprobante-pago\',
                                        { 
                                            id: auxilio.id,
                                            csrf_token: `';
		echo LR\HtmlHelpers::escapeAttr($csrf_token) /* pos 926:58 */;
		echo '`
                                        },
                                        { tipo: \'show\' }
...
<script>
    ...
    return {
        ...
        async verificarRenovacionVigente() {
            ...
            sendRequest({
                ...
                onError: (error) => {
                    ...
                    this.renovacionValida = false;
                    // console.error(\'Error:\', error);
                    // Toast.fire({icon: \'error\',title: \'Error al verificar renovación\'});
                },
            });
        },
        ...
        async crearSolicitud() {
            if (!this.renovacionValida) {
                Swal.fire({
                    icon: \'error\',
                    title: \'Error\',
                    text: \'La cuenta no tiene una renovación vigente al momento del fallecimiento.\'
                });
                return;
            }
        ...
        async guardarAprobacion() {
            if (!this.formularioAprobacion.monto_aprobar || this.formularioAprobacion.monto_aprobar <= 0) {
                Swal.fire({
                    icon: \'error\',
                    title: \'Error\',
                    text: \'Debe ingresar un monto válido para aprobar\'
                });
                return;
            }
            ...
            sendRequest({
                ...
                confirmMessage: \'¿Confirmar aprobación de auxilio por \' + this.formatMoney(this.formularioAprobacion.monto_aprobar) + \'?\',
                onSuccess: (data) => {
        ...
        async rechazarSolicitud(auxilio) {
            sendRequest({
                url: \'api/seguros/auxilios/\' + auxilio.id+ \'/rechazar\',  method: \'PUT\', confirmMessage: \'¿Confirmar el rechazo del auxilio?\',
                onSuccess: (data) => {
                    // console.log(data);
                    this.cargarSolicitudes(\'solicitado\');
                }
        ...
        async guardarPago() {
            submitForm(\'#formPago\', {
                ...
                confirmMessage: \'¿Confirmar el registro del pago por \' + this.formatMoney(this.formularioPago.monto) + \'?\',
                onSuccess: (data) => {
