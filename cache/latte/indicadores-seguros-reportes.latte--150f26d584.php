...
/** source: /var/www/html/app/Controllers/../../views/indicadores/seguros/reportes.latte */
final class Template_150f26d584 extends Latte\Runtime\Template
{
	...
	public function main(array $ʟ_args): void
	{
		...
		echo '<div class="container mx-auto p-4 sm:p-6" x-data="reportesAuxiliosApp()">
    <input type="hidden" name="csrf_token"';
		echo LR\HtmlHelpers::formatAttribute(' value', $csrf_token) /* pos 3:52 */;
		echo '>

    <!-- Header con Dashboard de Stats -->
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-base-content mb-2">📊 Reportes de Auxilios Póstumos</h1>
        <p class="text-base-content/70">Genera reportes personalizados en PDF, Excel o visualízalos en pantalla</p>
    </div>
    ...
    <div class="card bg-base-100 shadow-xl">
        ...
        <div x-show="activeTab === \'cuentas\'" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6" id="filtrosCuentas">
                ...
                <div class="form-control">
                    <label class="label"><span class="label-text">Identificación Cliente (opcional)</span></label>
        ...
        <div x-show="activeTab === \'auxilios\'" class="p-6">
            <h2 class="text-2xl font-bold mb-4 text-base-content">Reporte de Auxilios Póstumos</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6" id="filtrosAuxilios">
                ...
                <div class="form-control">
                    <label class="label"><span class="label-text">Monto Mínimo</span></label>
        ...
        <div x-show="activeTab === \'pagos\'" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6" id="filtrosPagos">
                ...
                <div class="form-control">
                    <label class="label"><span class="label-text">Monto Máximo</span></label>
        ...
        <div x-show="activeTab === \'estadisticas\'" class="p-6">
            <h2 class="text-2xl font-bold mb-4 text-base-content">Estadísticas y Análisis</h2>
            ...
            <div class="flex flex-wrap gap-3 mb-6">
                <button @click="generarReporteEstadistico()" class="btn btn-primary gap-2">
                    <span>📊</span> Generar Estadísticas
                </button>
        ...
        <div x-show="activeTab === \'personalizado\'" class="p-6">
            ...
            <p class="text-base-content/70 mb-6">Selecciona los criterios específicos para tu reporte</p>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6" id="filtrosPersonalizado">
                <!-- Sección: Datos a Incluir -->
                <div class="card bg-base-200 p-4">
                    <h3 class="font-bold text-lg mb-3">📋 Datos a Incluir</h3>
                    <div class="space-y-2">
                        <label class="label cursor-pointer justify-start gap-3">
                            <input type="checkbox" class="checkbox checkbox-primary" name="incluir_cuentas" checked>
                            <span>Información de Cuentas</span>
                        </label>
                        <label class="label cursor-pointer justify-start gap-3">
                ...
                <div class="card bg-base-200 p-4">
                    <h3 class="font-bold text-lg mb-3">📅 Filtros de Fecha</h3>
                    <div class="space-y-3">
                        <div class="form-control">
                ...
                <div class="card bg-base-200 p-4">
                    <h3 class="font-bold text-lg mb-3">🏷️ Estados</h3>
                    <div class="space-y-2">
                        <label class="label cursor-pointer justify-start gap-3">
                ...
                <div class="card bg-base-200 p-4">
                    <h3 class="font-bold text-lg mb-3">⚙️ Opciones de Formato</h3>
                    <div class="space-y-3">
                        <div class="form-control">
                        ...
                        <div class="form-control">
                            <label class="label"><span class="label-text">Límite de Registros</span></label>
        ...
        <!-- Área de Previsualización de Resultados -->
        <div x-show="showPreview" class="p-6 border-t border-base-300">
            <div class="flex justify-between items-center mb-4">
                ...
                <button @click="showPreview = false" class="btn btn-ghost btn-sm">✕ Cerrar</button>
            </div>
...
<script>
    ...
    return {
        ...
        mostrarResultados(datos, encabezados) {
            ...
            // Generar encabezados dinámicamente si no vienen
            ...
            this.chartInstance = new Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: \'Análisis Estadístico - Auxilios Póstumos\'
                        }
                    },
                    scales: {
                        y: {
