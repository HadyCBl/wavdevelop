...
// import $ from "jquery"; // no lo cargo porque ya se tiene globalmente
...
/**
 * Reinicializa todos los Select2 activos (útil al cambiar de tema)
 */
function refreshAllSelect2() {
  $(".select2-hidden-accessible").each(function() {
    ...
    $element.select2("destroy");
    $element.select2(currentOptions);
...
if (typeof window !== "undefined") {
  ...
  window.loadModuleView = loadModuleView;
  window.initSelect2 = initSelect2;
  window.refreshAllSelect2 = refreshAllSelect2;
}
