...
function BuscarNomenclatura($conexion){
    ...
    while ($registro = mysqli_fetch_array($consulta2, MYSQLI_ASSOC)) {
        ...
        $tipo = $registro["tipo"];
        $button = ($tipo == "D") ? '<button type="button" class="btn btn-success" onclick= "datos([`' . $id . '`])" >Seleccionar</button>' : "Cuenta de Resumen";
        echo '
...
<!-- ---------------------------------TERMINA EL MODAL  -->
<div class="modal fade" id="modal_nomenclatura" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" onclick="cerrarModal('modal_nomenclatura')">Cerrar</button>
            </div>
        </div>
    </div>
</div>
