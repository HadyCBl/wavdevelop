...
function BuscarCliaprt()
{
  ...
  $consulta2 = mysqli_query($conexion, "
    ...
    WHERE 
        ...
        AND idcod_cliente IN (SELECT ccodcli FROM aprcta WHERE estado = 'A') 
        AND estado = 1
");
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="table-responsive">
            <table id="tblahomcta" class="table table-striped table-hover" style="width: 100% !important; font-size: 12px;">
              <thead>
                <tr>
