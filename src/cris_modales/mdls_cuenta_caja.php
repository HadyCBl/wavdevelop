...
{
    //consult para poder traer las cuentas asociadas a los cuentasa caja en especifico 
    $consulta2 = mysqli_query($conexion, "SELECT id, ccodcta, cdescrip, tipo FROM 
    ctb_nomenclatura WHERE estado=1 AND id IN (SELECT id_nomenclatura_caja FROM tb_agencia)");
