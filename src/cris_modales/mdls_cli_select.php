    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="table-responsive">
          <table id="tb_buscaClient" class="table table-striped nowrap table-sm small-font" style="width: 100%;">
            <thead>
              <tr>
    ...
    $("#tb_buscaClient").DataTable({
      ...
      "columnDefs": [{
        ...
        render: function(data, type, row) {
          const datos = [row[0], row[1]];
          return `<button type=\"button\" class=\"btn btn-success\" data-bs-dismiss=\"modal\" onclick=\"seleccionar_cliente(['${row[0]}','${row[1]}'])\">Aceptar</button>`;
        }
      }],
      "bDestroy": true,
      "language": {
