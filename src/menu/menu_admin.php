...
try {
    ...
    $result = getpermisosmodules($database, $idagencia, 'A', $db_name_general);
    if ($result[0] == 0) {
        // $showmensaje = true;
    ...
    <div class="menu-bar">
        <div class="menu">
            <ul class="menu-links">
                ...
                <li class="nav-link">
                    <a href="./index.php">
                        <i class="fa-solid fa-house fa-xl" id="ico3"></i>
                ...
                foreach ($showmodules as $fila) {
                    ...
                    $icon = $fila['icon'];
                    $ruta = $fila['ruta'];
                    echo '<li class="nav-link"><a href="' . $ruta . '"><i class="' . $icon . '" id="ico3"></i>
                                <span class="text nav-text"  id="txtmenu">' . $descripcion . '</span></a>
                            </li>';
                }
                // echo '<li class="nav-link"><a href="./migrations.php"><i class="fa-piggy-bank" id="ico3"></i>
                //     <span class="text nav-text"  id="txtmenu">Admin clientes</span></a>
                // </li>';
                ?>
            </ul>
        </div>
