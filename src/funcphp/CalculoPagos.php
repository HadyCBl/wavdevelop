...
// Ejemplo de uso para pagos semanales
$creditoSemanal = new CalculoPagos(5000, 2.5, 24, 'semanal');
$tablaAmortizacionSemanal = $creditoSemanal->generarTablaAmortizacion();

echo "<pre>";
echo print_r($tablaAmortizacionSemanal);
echo "</pre>";
// return;


// echo "Amortización Semanal:\n";
// foreach ($tablaAmortizacionSemanal as $cuota) {
//     echo "Periodo {$cuota['periodo']}: Capital: {$cuota['capital']}, Interés: {$cuota['interes']}, Saldo Capital: {$cuota['saldoCapital']}\n";
// }

// Ejemplo de uso para pagos diarios
$creditoDiario = new CalculoPagos(500, 20, 20, 'diaria');
$tablaAmortizacionDiaria = $creditoDiario->generarTablaAmortizacion();

echo "<pre>";
echo print_r($tablaAmortizacionDiaria);
echo "</pre>";

// echo "\nAmortización Diaria:\n";
// foreach ($tablaAmortizacionDiaria as $cuota) {
//     echo "Periodo {$cuota['periodo']}: Capital: {$cuota['capital']}, Interés: {$cuota['interes']}, Saldo Capital: {$cuota['saldoCapital']}\n";
// }
