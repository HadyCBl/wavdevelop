...
if ($method == "POST") {
    ...
    // Log::info("usuariorestapi.php akiiiiiiiiiiii");
...
if ($method == "PUT") {
    ...
    try {
        ...
        if ($jsonOBJ->option == "verificar") {
            Log::info("HuellaRestApi.php: Verificando huella con serial1: " . $jsonOBJ->option);
            $huella_temp = array(
                "imgHuella" => $jsonOBJ->imageHuella,
                "update_time" => $hoy2,
                "fecha_actualizacion" => $hoy2,
            ...
            $ablyService->publisSinchHuellaDigital($jsonOBJ->serial, $huellaData);
        } else {
            Log::info("HuellaRestApi.php: Verificando huella con serial2: " . $jsonOBJ->option);
            $huella_temp = array(
                "imgHuella" => $jsonOBJ->imageHuella,
                "update_time" => $hoy2,
                "fecha_actualizacion" => $hoy2,
